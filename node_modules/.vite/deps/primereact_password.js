...
import {
  InputText
} from "./chunk-BDLN3MQC.js";
import {
  EyeIcon
} from "./chunk-GHOWNBMP.js";
import {
  OverlayService
} from "./chunk-OSBAYM42.js";
import {
  CSSTransition
} from "./chunk-BKN3S6VS.js";
import "./chunk-TDMPTNKP.js";
import {
  IconBase
} from "./chunk-3N6BWNJU.js";
import {
  Portal
} from "./chunk-GOK3GHY2.js";
import {
  ComponentBase,
  useHandleStyle,
  useOverlayListener,
  useUnmountEffect
} from "./chunk-L3OSL6Q2.js";
import "./chunk-2VGUONL3.js";
import {
  PrimeReact,
  PrimeReactContext,
  localeOption
} from "./chunk-OF2WISPE.js";
import {
  DomHandler,
  IconUtils,
  ObjectUtils,
...
var Password = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React2.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  var _React$useState3 = React2.useState(null), _React$useState4 = _slicedToArray2(_React$useState3, 2), meterState = _React$useState4[0], setMeterState = _React$useState4[1];
  var _React$useState5 = React2.useState(promptLabel), _React$useState6 = _slicedToArray2(_React$useState5, 2), infoTextState = _React$useState6[0], setInfoTextState = _React$useState6[1];
  var _React$useState7 = React2.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React2.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), unmaskedState = _React$useState10[0], setUnmaskedState = _React$useState10[1];
  ...
  var createIcon = function createIcon2() {
    ...
    if (props.toggleMask) {
      var content = React2.createElement("i", {
        onClick: toggleMask
      }, " ", eyeIcon, " ");
      if (props.icon) {
  ...
  return React2.createElement("div", rootProps, React2.createElement(InputText, inputTextProps), icon, panel2);
}));
