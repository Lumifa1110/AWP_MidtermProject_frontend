...
var useEventListener = function useEventListener2(_ref) {
  ...
  var listenerRef = React5.useRef(null);
...
var DownloadIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React5.useState(inProps.id), _React$useState2 = _slicedToArray5(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  React5.useEffect(function() {
...
var Image = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React5.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray5(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React5.useState(0), _React$useState6 = _slicedToArray5(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React5.useState(1), _React$useState8 = _slicedToArray5(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  ...
  var previewClick = React5.useRef(false);
  ...
  var createPreview = function createPreview2() {
    ...
    if (props.preview) {
      return React5.createElement("div", buttonProps, content);
    }
    return null;
  };
